  ...
  "zh-CN": {
    translation: {
      ...
      marketCard: {
        ...
        buy: "购买",
        hoverToZoom: "悬停图片可查看放大细节",
        fmv: "公允市值 (FMV)",
        fmvSource: "基于 Renaiss 实时定价",
        askPrice: "卖方报价",
        grade: "评级",
        set: "系列",
        artist: "画师",
  ...
  "zh-TW": {
    translation: {
      ...
      marketCard: {
        ...
        buy: "購買",
        hoverToZoom: "懸停圖片可查看放大細節",
        fmv: "公允市值 (FMV)",
        fmvSource: "基於 Renaiss 即時定價",
        askPrice: "賣方報價",
        grade: "評級",
        set: "系列",
        artist: "畫師",
  ...
  en: {
    translation: {
      ...
      marketCard: {
        ...
        buy: "Buy",
        hoverToZoom: "Hover over the image to zoom in",
        fmv: "Fair Market Value (FMV)",
        fmvSource: "Based on Renaiss real-time pricing",
        askPrice: "Ask Price",
        grade: "Grade",
        set: "Set",
        artist: "Artist",
  ...
  ja: {
    translation: {
      ...
      marketCard: {
        ...
        buy: "購入",
        hoverToZoom: "画像にホバーして拡大表示",
        fmv: "公正市場価値 (FMV)",
        fmvSource: "Renaiss リアルタイム価格に基づく",
        askPrice: "売り希望価格",
        grade: "グレード",
        set: "セット",
        artist: "アーティスト",
  ...
  ko: {
    translation: {
      ...
      marketCard: {
        ...
        buy: "구매",
        hoverToZoom: "이미지에 호버하여 확대 보기",
        fmv: "공정 시장 가치 (FMV)",
        fmvSource: "Renaiss 실시간 가격 기반",
        askPrice: "판매 희망가",
        grade: "등급",
        set: "세트",
        artist: "아티스트",
