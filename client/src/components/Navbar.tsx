...
const navItems = [
  ...
  { label: "卡牌故事", id: "card-story" },
  { label: "功能", id: "features" },
];

const subItems = [
  { label: "展览厅", en: "Gallery", icon: "🏛" },
  { label: "卡牌编年史", en: "Chronicle", icon: "📜" },
  { label: "卡牌星图", en: "Constellation", icon: "✦" },
  { label: "收藏家DNA", en: "Collector DNA", icon: "🧬" },
  { label: "卡牌图集", en: "Album", icon: "🎨" },
];
